...
Анимация работает быстро всех браузерах, даже IE8, были сделаны версии на jQuery и чистом JS, добавлена анимация роста. Если кратко, то была убрана рекурсия, которая вела к зависанию браузера и все элементы анимируются одним таймером.